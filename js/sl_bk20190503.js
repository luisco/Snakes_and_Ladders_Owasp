...
var packageMCQ = {};
shah.debug = true;
shah.prompt = [4,7,13, 20,27, 29, 35,36, 37,40, 42, 52, 62, 63,64, 67,75, 82, 84,88,92,96];
shah.struct = [ {point: 4, snake: 4, ladder: 46},
				{point: 7, snake: 7, ladder: 26}, 
				{point: 13, snake: 13, ladder: 33}, 
				{point: 20, snake: 20, ladder: 39}, 
				{point: 27, snake: 6, ladder: 27}, 
				{point: 29, snake: 29, ladder: 70}, 
				{point: 35, snake: 35, ladder: 53}, 
				{point: 36, snake: 18, ladder: 36}, 
				{point: 37, snake: 37, ladder: 58},
				{point: 40, snake: 19, ladder: 40},				
				{point: 42, snake: 42, ladder: 62}, 
				{point: 52, snake: 52, ladder: 94},
				{point: 62, snake: 60, ladder: 81}, 
				{point: 63, snake: 19, ladder: 63},
				{point: 64, snake: 64, ladder: 83},
				{point: 67, snake: 64, ladder: 83},
				{point: 75, snake: 54, ladder: 75}, 
				{point: 82, snake: 41, ladder: 82}, 
				{point: 84, snake: 45, ladder: 84}, 
				{point: 88, snake: 67, ladder: 88}, 
				{point: 92, snake: 51, ladder: 92}, 
				{point: 96, snake: 3, ladder: 96}];
